...
@click.option(
    ...
    "--first-goal",
    type=str,
    default="Find the API spec, register a user, get authenticated, then explore as many endpoints as possible.",
...
@click.option(
    ...
    "--generator-id",
    type=str,
    default="ollama/llama3.1,api_base=http://localhost:11434",
    required=True,
